...
currDate.innerHTML = currentYear;
musicExp.innerHTML = currentYear - 2009;
...
//       hiddenContent.style.display = "flex"; // Show the hidden content
//       this.textContent = "Show less"; // Change button text to "Show less"
//   } else {
//       hiddenContent.style.display = "none"; // Hide the content again
